...
```{r}
set.seed(950)
a = matrix(rnorm(300*500), nrow = 300, ncol = 500)
b = matrix(rnorm(300*500), nrow = 300, ncol = 500)
...
```{r}
set.seed(950)
a = matrix(rnorm(50*100), nrow = 50, ncol = 100)
b = matrix(rnorm(50*100), nrow = 50, ncol = 100)
